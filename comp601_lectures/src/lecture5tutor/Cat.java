...
public class Cat {
  ...
  // no type definition(ex. int) & "return" necessary coz when it called by "new", left side specify the type of argument (ex. "Cat cat1" specify to return "Cat" type object('s address))
